...
public class ShobeKodorerFojilotActvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shobe_kodorer_fojilot_actvity);
        actionBar = getSupportActionBar();
        actionBar.setTitle(getString(R.string.ShobeKodorerFojilot));
